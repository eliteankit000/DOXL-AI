...
export const metadata = {
  title: 'How to Convert Invoices to Excel Automatically — Love2Excel',
  description:
  ...
  alternates: { canonical: 'https://love2excel.ai/blog/invoice-to-excel' },
};
        ...
        <main role="main" className="max-w-3xl mx-auto px-4 py-16">
          ...
          <article className="prose prose-slate max-w-none">
            ...
            <ol className="list-decimal pl-6 space-y-2 text-muted-foreground mb-6">
              <li><strong>Upload your invoice PDF or image</strong> to <Link href="/" className="text-primary underline">love2excel.ai</Link>. Drag and drop or click to browse. JPG and PNG receipt photos work too.</li>
