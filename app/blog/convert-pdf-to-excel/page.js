...
export const metadata = {
  title: 'How to Convert PDF to Excel (Free, Online, in Seconds) — DocXL AI',
  description:
      ...
      <div className="min-h-screen bg-background">
        ...
        <main role="main" className="max-w-3xl mx-auto px-4 py-16">
          ...
          <article className="prose prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-semibold mt-10 mb-4">Method 1 — Using DocXL AI (Recommended)</h2>
            <p className="text-muted-foreground mb-4">DocXL AI is an online tool that uses GPT-4o to read your PDF and extract every table, row, and column into a clean Excel file. Here is how to use it:</p>
            <ol className="list-decimal pl-6 space-y-2 text-muted-foreground mb-6">
              <li><strong>Go to <Link href="/" className="text-primary underline">docxl.ai</Link></strong> and sign up for free. You get 5 free conversions instantly — no credit card required.</li>
              <li><strong>Upload your PDF.</strong> Drag and drop or click to browse. DocXL AI supports PDF, JPG, and PNG files up to 6 pages per conversion.</li>
            ...
            <p className="text-muted-foreground mb-6">The entire process takes under 30 seconds for most documents. DocXL AI works especially well with invoices, bank statements, price lists, and any PDF with structured tables.</p>
            ...
            <p className="text-muted-foreground mb-4">For speed, accuracy, and ease of use, <strong>DocXL AI is the best choice</strong>. It uses GPT-4o (OpenAI&apos;s most capable model) to understand context — not just read pixels. It handles merged cells, multi-column layouts, and scanned documents that basic OCR tools struggle with. And it is free to start with 5 conversions.</p>

            <h2 className="text-2xl font-semibold mt-10 mb-4">Frequently Asked Questions</h2>
            <div className="space-y-4 mb-8">
              <div><h3 className="font-medium">Can I convert a scanned PDF to Excel?</h3><p className="text-sm text-muted-foreground">Yes. DocXL AI uses GPT-4o vision to read scanned documents and extract table data, even from low-quality scans.</p></div>
              ...
              <div><h3 className="font-medium">Do I need to install any software?</h3><p className="text-sm text-muted-foreground">No. DocXL AI works entirely in your browser. No downloads or plugins needed.</p></div>
            </div>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 text-center mt-10">
              ...
              <p className="text-muted-foreground mb-4">Try DocXL AI free — no credit card required.</p>
              <Link href="/" className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground px-6 py-3 text-sm font-medium hover:bg-primary/90">Try DocXL AI free \u2192</Link>
            </div>
          </article>
        </main>
