...
export const metadata = {
  ...
  description:
    ...
    'transaction date, description, debit, credit, and balance columns automatically. Free with Love2Excel.',
  alternates: { canonical: 'https://love2excel.ai/blog/bank-statement-to-excel' },
};
      ...
      <div className="min-h-screen bg-background">
        ...
        <main role="main" className="max-w-3xl mx-auto px-4 py-16">
          ...
          <article className="prose prose-slate max-w-none">
            ...
            <p className="text-lg text-muted-foreground mb-8">Whether you need bank data in Excel for budgeting, accounting, tax preparation, or expense tracking, manually typing transactions from a PDF bank statement is one of the most tedious data tasks. Love2Excel automates the entire process using GPT-4o AI.</p>

            <h2 className="text-2xl font-semibold mt-10 mb-4">Columns Love2Excel Extracts from Bank Statements</h2>
            ...
            <ol className="list-decimal pl-6 space-y-2 text-muted-foreground mb-6">
              <li><strong>Upload your bank statement PDF</strong> to <Link href="/" className="text-primary underline">love2excel.ai</Link>. You can also upload a screenshot or photo of a printed statement.</li>
